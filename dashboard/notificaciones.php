            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <form id="alertForm">
                        ...
                        <button type="button" onclick="agregarAlerta()">Agregar Alerta</button>
                        <button type="button" onclick="mostrarAlertas()">Mostrar Alertas</button>
                    </form>
                    <table id="alertTable">
                    <thead>
                        <tr>
